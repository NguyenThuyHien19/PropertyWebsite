    ...
    <>
        ...
        <nav className="site-nav">
            ...
            <div className="menu-bg-wrap">
                ...
                <ul className="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">     
                    <li className="active"><Link to="/home" className={paths === 'home' ? 'bds_page' : paths === 'properties' ? 'home_page' : ''}>TRANG CHỦ</Link></li>
                    <li><Link to="/aboutus">GIỚI THIỆU</Link></li>
                    <li><a href="news.html">TIN TỨC</a></li>
                    <li className="has-children ">
                        <Link to='/properties' className={paths === 'home' ? 'home_page' : paths === 'properties' ? 'bds_page' : ''}>BĐS</Link>
        ...
        <div className="hero page-inner overlay" style={{backgroundImage: 'url("images/hero_bg_3.jpg")'}}>
            ...
            <div className="row justify-content-center align-items-center">
                ...
                <h1 className="heading" data-aos="fade-up">Bất Động Sản</h1>
